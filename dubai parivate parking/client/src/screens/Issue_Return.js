...
import {getAllcheckinBook} from "../actions/Issue_action"
import { useDispatch, useSelector } from 'react-redux'
import moment from 'moment';

const Issue_checkout = () => {
    ...
    const filterOut = ()=>{
        ...
        //console.log(todayDate)
         filterd = all_checkinBook && all_checkinBook.filter(item =>  (item.updatedAt.slice(0,10) == todayDate))
