    ...
    checkout (
        <div>
             ...
             <Toast onClose={() => setShow(false)} show={show} delay={3000} autohide>
                 <Toast.Body style={{backgroundColor:"blue",color:"white",fontSize:"18px"}}>One Customer Added</Toast.Body>
              </Toast>
             ...
             <div style={{marginTop:"20px"}}>
                    ...
                    <div style={{marginTop:"20px"}}>
                        <input type="text" className="form-control" style={{height:"60px",borderRadius:"20px"}}
                         placeholder="Emirates Id" value={emp_id} onChange={(e) => setEmpId(e.target.value)} />
             </div>
             <br />
             <br />
